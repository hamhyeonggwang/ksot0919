...
웹 index.html과 별도 파일. 텍스트 수정은 CONTENT.md 먼저 → 본 문서·Figma 반영.
...
풀 A — 일정·강사·9.19 타임테이블 전부 (아코디언 장문 불릿은 QR/웹)
...
Editorial Tech — Bento · Glass · Giant 9.19 · Dark Hero
...
가독성 부족 시 A1 세로 (594×841mm), 레이아웃 동일
...
images/location/대전보건대학교전경.jpeg
...
접수안내 URL 또는 https://hamhyeonggwang.github.io/ksot0919/
...
images/logos/대한작업치료학회.png 등 4종
...
아래 블록을 Zone별 텍스트 레이어에 그대로 붙여넣고, 수정 시 CONTENT.md와 함께 갱신한다.
...
보수교육 — AI 시대 작업치료사에게 필요한 역량과 준비 / Occupation Flow : AI Workflow 설계 (함형광) · 동시: 대학원생 워크샵(장정열) · 동시: 캡스톤 디자인 발표
...
https://www.ksot.kr/?bid=sympo_info&m=bbs
...
Figma A2-Poster-Final 수정



PDF 재export

웹 index.html과 포스터는 디자인 분리, 콘텐츠만 공유.
