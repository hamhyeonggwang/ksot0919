...
const CEU_CLINICIAN_CONFIG = {
  sheetName: '보수교육_작업치료사',
  columns: [
    ['제출시각',                 'timestamp'],
    ['성명',                     'name'],
    ['이메일',                   'email'],
...
// '학생'·'일반참가자' 는 submissions_ceu_student 테이블·시트를 함께 쓰고
// '구분'(role) 열로 어느 쪽인지 구별한다.
const CEU_STUDENT_CONFIG = {
  sheetName: '보수교육_학생_일반참가자',
  columns: [
    ['제출시각',                 'timestamp'],
    ['구분',                     'role'],
    ['성명',                     'name'],
...
const SHEET_CONFIG = {
  '작업치료사': CEU_CLINICIAN_CONFIG,
  '학생': CEU_STUDENT_CONFIG,
  '일반참가자': CEU_STUDENT_CONFIG,
  '대학원생 워크숍': {
    sheetName: '대학원생_워크숍',
    columns: [
      ['제출시각',                 'timestamp'],
